...
public class Deposit extends HttpServlet {
	private static final long serialVersionUID = 1L;
		...
		try {
			...
			String query2="select amount,name from saving where accountno=?";
			...
			if (rs1.next()) {
				...
				if (i != 0) {
					...
					RequestDispatcher rd = request.getRequestDispatcher("DisplayDep.jsp");
